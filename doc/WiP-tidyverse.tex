...
\tightlist
\item
  \texttt{API\_SG.GEN.PARL.ZS\_DS2\_en\_csv\_v2\_713162.csv}
\end{itemize}
...
\begin{verbatim}
 ...
 2  
 3  "Last Updated Date","2019-12-20",
 4  
\end{verbatim}
...
\StringTok{  }\KeywordTok{pivot_longer}\NormalTok{(}\KeywordTok{starts_with}\NormalTok{(}\StringTok{"X"}\NormalTok{), }
               \DataTypeTok{names_to =} \StringTok{"YearC"}\NormalTok{, }
               \DataTypeTok{values_to =} \StringTok{"pctWiP"}\NormalTok{, }
               \DataTypeTok{values_drop_na =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\item
  What is the world percentage of women in parliament in 2019?
\end{itemize}
...
\CommentTok{#  24 Portugal PRT    2019   35.6  1.81}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#   7 Rwanda  RWA    2019   61.2 0.633}
\CommentTok{#   8 Rwanda  RWA    2008   56.3 0.776}
\CommentTok{#   9 Rwanda  RWA    2009   56.3 0.776}
\CommentTok{#  10 Rwanda  RWA    2010   56.3 0.776}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#  24 Rwanda  RWA    2019   61.2 0.633}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#     <chr>                       <dbl>}
\CommentTok{#   1 Romania                    -13.7 }
\CommentTok{#   2 Armenia                    -11.4 }
\CommentTok{#   3 Hungary                     -8.14}
\CommentTok{#   4 Mongolia                    -7.79}
\CommentTok{#   5 Guinea-Bissau               -6.27}
\CommentTok{#   6 Guyana                      -5.02}
\CommentTok{#   7 Vanuatu                     -4.3 }
\CommentTok{#   8 Yemen, Rep.                 -3.77}
\CommentTok{#   9 Korea, Dem. People’s Rep.   -3.49}
\CommentTok{#  10 Congo, Rep.                 -3.04}
\CommentTok{#  11 Mali                        -2.68}
\CommentTok{#  12 Maldives                    -1.7 }
\CommentTok{#  13 Tuvalu                      -1.45}
\CommentTok{#  14 Oman                        -1.22}
\CommentTok{#  15 Haiti                       -1.06}
\CommentTok{#  16 Turkmenistan                -1   }
\CommentTok{#  17 Nigeria                     -0.02}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#  24 Portugal  2019   35.6  1.81  33      191}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#  24 Portugal  2019   35.6  1.81  14       43}
\end{Highlighting}
\end{Shaded}
