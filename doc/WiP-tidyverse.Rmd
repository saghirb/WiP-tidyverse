...
We have suppressed some of the messages but left the one about variable `X65` (we 
...
```{r decline5pct, fig.width=3.5, fig.height=2.4}
...
[^pctWiPcharError]: Uncomment this line if the `gather()` functions gives you 
character `pctWiP`.
